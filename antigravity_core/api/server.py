...
# SHA-256 fingerprint below is from android.keystore generated by Bubblewrap
_TWA_SHA256 = os.getenv("TWA_SHA256_FINGERPRINT", "BE:87:6D:45:1E:71:90:02:47:AC:DF:A8:D9:A9:B6:7F:06:97:B8:48:BF:B6:2A:D3:2E:A6:8D:36:36:4C:31:BD")
...
def api_semester_today_subtasks():
    ...
    this cache instead of re-querying Canvas. completed reflects Canvas's
    real per-item progress — Task 10 is auto-synced/audited, so this is
    read-only, never manually toggleable.
    """
    try:
